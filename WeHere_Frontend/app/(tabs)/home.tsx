...
//   // Like state: which posts current user has liked
//   const [likedMap, setLikedMap] = useState<{ [postId: number]: boolean }>({});
  
//   // Save state: which posts current user has saved
...
//         // Alert.alert(
//         //   'Success',
//         //   json.saved ? 'Post saved successfully!' : 'Post unsaved.'
//         // );
//       } else {
//         // rollback
//         setSavedMap((prev) => ({ ...prev, [postId]: wasSaved }));
...
//             <View key={`user-${group.userId}`} style={styles.userGroup}>
...
//       {/* Create post modal – unchanged UX */}
//       <Modal
//         animationType="slide"
//         transparent
